...
for T in range (200,20000, 100):
   Tin= np.append(Tin,T)
   cpN2_J= np.append(cpN2_J,cp_N2(T))
   cpO2_J= np.append(cpO2_J,cp_O2(T))
   cpH2_J= np.append(cpH2_J,cp_H2(T))


for T2 in range (200,6000, 100):
   Tin2= np.append(Tin2,T2)
   cpAir_J= np.append(cpAir_J,cp_Air(T2))


plt.plot(Tin2,cpAir_J, color='green',linestyle='-', label="Air")
plt.plot(Tin,cpN2_J, color='blue',linestyle='--', label="N\u2082")
plt.plot(Tin,cpO2_J, color='red',linestyle=':', label="O\u2082")
plt.plot(Tin,cpH2_J, color='black',linestyle='dashdot', label="H\u2082")
plt.grid(color='grey', linestyle='--', linewidth=0.5)
plt.xlabel('T [K]')
plt.ylabel('cp [J/Kmol]')
plt.legend(ncol=4)
plt.show()
